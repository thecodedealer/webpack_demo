"use strict";
module.exports = angular.module('mainLayoutComponent', [])
    .component('mainLayout', {
        ...
        template: `
            <div class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
                <a class="navbar-brand" href="index.html">Angular Dashboard</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                        ...
                        <!--Side nav components-->
                        <li ng-repeat="(nav, config) in navigationService.getSideNav()"
                            class="nav-item" data-toggle="tooltip" data-placement="right" title="{{nav}}"
                            >
                            <a class="nav-link" ui-sref="{{config.state}}" ui-sref-active="navActive">
                                <i class="fa fa-fw fa-{{config.logo}}"></i>
                                <span class="capitalize nav-link-text">{{nav}}</span>
                            </a>
                        </li>
                ...
                <!--        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
                    ...
                    <ul class="navbar-nav sidenav-toggler">
                        <li class="nav-item">
                            <a class="nav-link text-center" id="sidenavToggler" ng-click="navigationService.toggleSideNav()">
